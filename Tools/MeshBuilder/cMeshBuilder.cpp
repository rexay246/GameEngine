...
eae6320::cResult eae6320::Assets::cMeshBuilder::Load(const std::string& i_path)
{
...
eae6320::cResult eae6320::Assets::cMeshBuilder::LoadTableValues(lua_State& io_luaState)
{
	...
	outfile.write(reinterpret_cast<const char*>(vertexData), 
		sizeof(eae6320::Graphics::VertexFormats::sVertex_mesh) * vertexCount);
...
eae6320::cResult eae6320::Assets::cMeshBuilder::LoadTableValues_Vertices_Paths(lua_State& io_luaState,
	eae6320::Graphics::VertexFormats::sVertex_mesh*& vertexData,
	unsigned int& vertexCount)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Assets::cMeshBuilder::LoadTableValues_Indices_Paths(lua_State& io_luaState,
	uint16_t*& indexData, unsigned int& indexCount)
{
	auto result = eae6320::Results::Success;
...
eae6320::cResult eae6320::Assets::cMeshBuilder::LoadTableValues_Indices_Paths_Vertices(lua_State& io_luaState,
