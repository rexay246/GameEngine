...
#ifndef EAE6320_ALIENBREAK_H
#define EAE6320_ALIENBREAK_H
...
namespace eae6320
{
	...
	private:
		...
		const WORD* GetLargeIconId() const final { static constexpr WORD iconId_large = IDI_RAYDOG; return &iconId_large; }
